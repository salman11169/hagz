...
PROMPT;
    ...
    private static function localFallback(
        ...
        // High-risk keywords (matching new trusted-source symptoms)
        $criticalKeywords = [
            'ألم حاد أو ضغط في الصدر', 'ألم شديد في الصدر',
            'صعوبة شديدة في التنفس', 'صعوبة في التنفس',
            'فقدان الوعي أو الإغماء', 'فقدان الوعي',
            'نزيف حاد غير مُسيطر عليه', 'نزيف غير متوقف',
            'شلل أو خدر مفاجئ في الوجه أو الأطراف', 'شلل مفاجئ',
            'تشنجات أو نوبات صرع',
        ...
        // Medium keywords (matching new trusted-source symptoms)
        $urgentKeywords = [
            'حمّى شديدة (أعلى من 39°)', 'ارتفاع حرارة شديد',
            'ألم حاد في البطن', 'ألم شديد في البطن',
            'دوخة مستمرة مع غثيان أو قيء', 'دوخة وغثيان',
            'ألم حاد في الظهر أو العمود الفقري', 'ألم في الظهر والعمود',
            'صداع شديد ومفاجئ غير معتاد',
            'تورّم مفاجئ في الوجه أو الحلق',
            'ضيق تنفس عند المشي أو الاستلقاء',
        ];
        foreach ($symptoms as $s) {
    ...
    {
        $map = [
            'أعصاب'       => ['رأس', 'صداع', 'دوخ', 'دوار', 'عصب', 'شلل', 'خدر', 'تنميل', 'صرع', 'ذاكرة', 'تشنج', 'كلام', 'فهم', 'نوبات'],
            'طب باطني'    => ['قلب', 'صدر', 'رئة', 'تنفس', 'ضغط', 'سكري', 'كلى', 'كبد', 'حمى', 'حرارة', 'إعياء', 'غثيان', 'قيء', 'عطش', 'جفاف'],
            'جراحة'        => ['بطن', 'التهاب زائدة', 'فتق', 'كيس', 'ورم', 'عملية'],
            'عظام'         => ['عظم', 'عمود', 'مفصل', 'كسر', 'ظهر', 'ركبة', 'كاحل', 'ورك', 'يد', 'قدم', 'عضلات', 'فقري'],
            'أطفال'        => ['طفل', 'رضيع', 'ولد', 'بنت', 'أطفال'],
            'نساء وولادة' => ['نساء', 'حمل', 'ولادة', 'دورة', 'رحم', 'مبيض'],
            'طب طوارئ'    => ['حادث', 'صدمة', 'نزيف', 'إغماء', 'تسمم', 'حريق', 'كسر مفتوح', 'تشنجات', 'فقدان الوعي'],
            'طب عام'      => ['زكام', 'إنفلونزا', 'سعال', 'التهاب حلق', 'إرهاق', 'نوم', 'شهية', 'حكة', 'طفح', 'جلد', 'احتقان', 'رشح', 'حلق', 'تورم'],
        ];
